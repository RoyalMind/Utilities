    ...
    private static Object parse(final XMLTokener xmlTokener, final boolean b, final JSONArray jsonArray) throws JSONException {
        while (xmlTokener.more()) {
            ...
            if (nextContent == XML.LT) {
                    ...
                    while (true) {
                        ...
                        if (!(o instanceof String)) {
                            ...
                            if (o == XML.EQ) {
                                ...
                                jsonObject.accumulate(s3, XML.stringToValue((String)nextToken3));
                                o = null;
                            }
                            else {
                ...
                jsonArray.put((nextContent instanceof String) ? XML.stringToValue((String)nextContent) : nextContent);
            }
        }
